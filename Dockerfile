...
# The lockfile is generated by npm 11; node:20.19-slim ships npm 10.8 which
# cannot parse some lockfile-v3 entries (e.g. nested utf-8-validate@5.0.10
# under telegram/websocket). Upgrade npm before `npm ci`.
